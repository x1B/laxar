...
], function( ng, assert, layoutModule, pageLoader, widgetLoader, paths, pageToolingApi, layoutWidgetAdapter, flowModule, createAreaHelper, createLocaleEventManager, createVisibilityEventManager ) {
   'use strict';
      ...
      var createPageControllerInjected = pageControllerDependencies
            ...
            function setupPage( pageName ) {
               ...
               var pagePromise = pageLoader_.loadPage( pageName )
                  .then( function( page ) {
                     pageToolingApi.setPage( pageName, page );
